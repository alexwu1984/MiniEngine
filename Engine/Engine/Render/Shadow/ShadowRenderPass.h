...
namespace Engine
{
	...
	public:
		...
		/** Cascaded directional shadow matrices + splits; false if last shadow pass did not produce CSM data. */
		bool TryGetCachedDirectionalCSM(CBDirectionalShadowCSM& Out) const;
