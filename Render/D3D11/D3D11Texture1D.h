...
namespace RenderCore
{
	...
	public:
		...
		virtual bool CreateWithData(EPixelFormat Format, ETextureCreateFlags Flags, int32_t SizeX, void* InBuffer, int RowBytes) override;
	...
	private:
		std::shared_ptr< D3D11Texture1DP> Data;
	};
}